...
const BorderVerticleOutlined: BorderVerticleOutlinedIconType = (props, context) => <Icon name='BorderVerticleOutlined' {...{ ...props, ...context.attrs }} icon={BorderVerticleOutlinedSvg} />;
