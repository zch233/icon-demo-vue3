...
const CustomerServiceFilled: CustomerServiceFilledIconType = (props, context) => <Icon name='CustomerServiceFilled' {...{ ...props, ...context.attrs }} icon={CustomerServiceFilledSvg} />;
