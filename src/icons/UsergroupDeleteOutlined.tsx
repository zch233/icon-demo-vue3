...
const UsergroupDeleteOutlined: UsergroupDeleteOutlinedIconType = (props, context) => <Icon name='UsergroupDeleteOutlined' {...{ ...props, ...context.attrs }} icon={UsergroupDeleteOutlinedSvg} />;
