...
const ReconciliationOutlined: ReconciliationOutlinedIconType = (props, context) => <Icon name='ReconciliationOutlined' {...{ ...props, ...context.attrs }} icon={ReconciliationOutlinedSvg} />;
