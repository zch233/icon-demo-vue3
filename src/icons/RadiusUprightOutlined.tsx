...
const RadiusUprightOutlined: RadiusUprightOutlinedIconType = (props, context) => <Icon name='RadiusUprightOutlined' {...{ ...props, ...context.attrs }} icon={RadiusUprightOutlinedSvg} />;
