...
const BorderHorizontalOutlined: BorderHorizontalOutlinedIconType = (props, context) => <Icon name='BorderHorizontalOutlined' {...{ ...props, ...context.attrs }} icon={BorderHorizontalOutlinedSvg} />;
