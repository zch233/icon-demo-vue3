...
const InsertRowBelowOutlined: InsertRowBelowOutlinedIconType = (props, context) => <Icon name='InsertRowBelowOutlined' {...{ ...props, ...context.attrs }} icon={InsertRowBelowOutlinedSvg} />;
