...
const SortAscendingOutlined: SortAscendingOutlinedIconType = (props, context) => <Icon name='SortAscendingOutlined' {...{ ...props, ...context.attrs }} icon={SortAscendingOutlinedSvg} />;
