...
const CopyrightCircleTwoTone: CopyrightCircleTwoToneIconType = (props, context) => <Icon name='CopyrightCircleTwoTone' {...{ ...props, ...context.attrs }} icon={CopyrightCircleTwoToneSvg} />;
