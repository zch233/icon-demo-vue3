...
const InsertRowAboveOutlined: InsertRowAboveOutlinedIconType = (props, context) => <Icon name='InsertRowAboveOutlined' {...{ ...props, ...context.attrs }} icon={InsertRowAboveOutlinedSvg} />;
