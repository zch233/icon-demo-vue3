...
const FileExclamationFilled: FileExclamationFilledIconType = (props, context) => <Icon name='FileExclamationFilled' {...{ ...props, ...context.attrs }} icon={FileExclamationFilledSvg} />;
