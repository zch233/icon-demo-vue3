...
const QuestionCircleTwoTone: QuestionCircleTwoToneIconType = (props, context) => <Icon name='QuestionCircleTwoTone' {...{ ...props, ...context.attrs }} icon={QuestionCircleTwoToneSvg} />;
